...
<table border="1px" style="border-collapse:collapse;" class="quan-li-xem-sua">
    ...
    $sql = "select id_loai, ten_loai, ten_hieu, quanliloaisanpham.tinh_trang as tinh_trang from quanliloaisanpham 
    join quanlihieusanpham on quanlihieusanpham.id_hieu = quanliloaisanpham.id_hieu where ten_loai like '%$tim_kiem%'";
    ...
    if ($row == 0) {
        echo "<tr><td colspan='5'>Chưa nhập loại sản phẩm trên</td></tr>";
    } else {
